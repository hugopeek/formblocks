...
<div class="form-group [[!+fb[[*id]].error.[[+name]]:notempty=`has-error`]]">
    ...
    <div class="[[+field_layout:is=`form-horizontal`:then=`col-sm-8`:else=`form-default`]]">
        ...
        <input type="[[+field_type]]" class="form-control" name="[[+name]]" id="[[+name]]" value="[[!+fb[[*id]].[[+name]]]]" placeholder="[[+field_placeholder]]" [[+field_helptext:notempty=`aria-describedby="[[+name]]-help"`]]>
