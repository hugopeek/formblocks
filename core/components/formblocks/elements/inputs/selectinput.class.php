...
class SelectInput extends cbBaseInput {
    ...
    public function getJavaScripts() {
        $assetsUrl = $this->modx->getOption('formblocks.assets_url', null, MODX_ASSETS_URL . 'components/formblocks/');
        return array(
    ...
    public function getTemplates()
    {
        ...
        $corePath = $this->modx->getOption('formblocks.core_path', null, MODX_CORE_PATH . 'components/formblocks/');
